...
一键安装命令
```
sudo curl -fsSL https://github.com/92Xiaowang/docker_installer/releases/download/latest/linux.sh| bash -s docker --mirror Aliyun
```
...
https://github.com/92Xiaowang/docker_installer/releases
...
项目地址: 
https://github.com/92Xiaowang/docker_image_pusher
